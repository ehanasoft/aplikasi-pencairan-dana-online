...
public class ProsesEditMataAnggaranServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            MataAnggaran mataAnggaran = daftarMataAnggaran.findMataAnggaran(longIdMataAnggaran);
            ...
            if (kodeMataAnggaran == "") {
                ...
                daftarMataAnggaran.edit(mataAnggaran);
